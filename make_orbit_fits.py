...
OUTPUT_BASE = 'representative_pool'
OUTFILENAME = 'Simulation_Data_Representative.h5'

if __name__ == '__main__':
    # Make the sample
    np.random.seed(1)
    sample_parameters = ForwardModeling.make_representative_sample(GAMMA, MU, SIGMA, ETA,
                                                                   size=N_SAMPLE,
                                                                   min_mass=MIN_MASS,
                                                                   max_mass=MAX_MASS)
