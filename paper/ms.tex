...
TODO: Describe imaging observations (band, observation time, etc). Add a table for this!
...
\begin{longtable*}{|l|rrlrrrlll|}
\hline
       star &  WDS & $N_\mathrm{obs}$   &   $T_\mathrm{eff}$ &   $v\sin{i}$ &  [Fe/H] & $\Delta K$ &   Isochrone Mass &   Spectral Type Mass \\
\hline
\endhead
\hline
\multicolumn{3}{r}{{Continued on next page}} \\
...
\hline
\endlastfoot
   HIP 2548 & \nodata &     1 &  $5732 \pm 112$ &      30 &    -0.5 &          0 &  $1.0^{+0.06}_{-0.04}$ &  $1.0^{+0.04}_{-0.03}$ \\
   HIP 5310 & \nodata &     1 &  $3343 \pm 154$ &      30 &     0.0 &          0 &  $0.3^{+0.13}_{-0.08}$ &  $0.4^{+0.12}_{-0.12}$ \\
     HR 545 & \nodata &     1 &   $4312 \pm 87$ &       5 &    -0.5 &          0 &  $0.8^{+0.11}_{-0.10}$ &  $0.7^{+0.01}_{-0.02}$ \\
     HR 604 & \nodata &     1 &  $4736 \pm 150$ &       5 &     0.5 &          0 &    $nan^{+nan}_{-nan}$ &  $0.8^{+0.02}_{-0.02}$ \\
  HIP 10732 & \nodata &     1 &  $5578 \pm 109$ &       5 &     0.0 &          0 &  $1.0^{+0.29}_{-0.04}$ &  $1.0^{+0.02}_{-0.04}$ \\
  HIP 12332 & \nodata &     1 &  $5551 \pm 107$ &      10 &     0.0 &          0 &    $nan^{+nan}_{-nan}$ &  $1.0^{+0.01}_{-0.04}$ \\
  HIP 12706 & \nodata &     1 &  $6051 \pm 107$ &      10 &     0.0 &          0 &  $1.1^{+0.03}_{-0.03}$ &  $1.1^{+0.04}_{-0.05}$ \\
  HIP 13165 & \nodata &     1 &  $5773 \pm 163$ &       5 &    -0.5 &          0 &  $1.1^{+0.31}_{-0.08}$ &  $1.0^{+0.10}_{-0.03}$ \\
  HIP 13327 & \nodata &     1 &  $5524 \pm 150$ &       5 &    -0.5 &          0 &  $1.2^{+0.20}_{-0.21}$ &  $1.0^{+0.03}_{-0.04}$ \\
  HIP 14576 & \nodata &     1 &  $6980 \pm 103$ &      10 &     0.0 &          0 &  $1.4^{+0.03}_{-0.03}$ &  $1.5^{+0.05}_{-0.03}$ \\
  HIP 14764 & \nodata &     1 &  $5601 \pm 108$ &      30 &     0.5 &          0 &    $nan^{+nan}_{-nan}$ &  $1.0^{+0.03}_{-0.03}$ \\
  HIP 16244 & \nodata &     1 &  $5592 \pm 107$ &       5 &    -0.5 &          0 &  $1.2^{+0.20}_{-0.22}$ &  $1.0^{+0.03}_{-0.03}$ \\
  HIP 16340 & \nodata &     1 &  $6214 \pm 150$ &       5 &    -0.5 &          0 &  $1.2^{+0.29}_{-0.07}$ &  $1.2^{+0.06}_{-0.05}$ \\
  HIP 16611 & \nodata &     1 &  $5476 \pm 154$ &       1 &     0.5 &          0 &  $0.9^{+0.04}_{-0.04}$ &  $0.9^{+0.04}_{-0.03}$ \\
  HIP 17563 & \nodata &     1 &  $8574 \pm 147$ &       5 &     0.5 &          0 &  $1.9^{+0.25}_{-0.11}$ &  $2.0^{+0.05}_{-0.06}$ \\
  HIP 18724 & \nodata &     1 &  $6831 \pm 154$ &      20 &     0.0 &          0 &  $1.7^{+0.13}_{-0.23}$ &  $1.4^{+0.04}_{-0.04}$ \\
  HIP 19949 & \nodata &     1 &  $6492 \pm 155$ &      20 &    -0.5 &          0 &  $1.3^{+0.06}_{-0.05}$ &  $1.3^{+0.06}_{-0.06}$ \\
  HIP 20380 & \nodata &     1 &  $6492 \pm 109$ &      20 &    -0.5 &          0 &  $1.3^{+0.04}_{-0.04}$ &  $1.3^{+0.03}_{-0.05}$ \\
  HIP 21589 & \nodata &     1 &  $4562 \pm 154$ &       5 &     0.0 &          0 &  $0.7^{+0.04}_{-0.03}$ &  $0.8^{+0.02}_{-0.03}$ \\
  HIP 22833 & \nodata &     1 &  $4745 \pm 107$ &      10 &     0.0 &          0 &  $0.8^{+0.02}_{-0.02}$ &  $0.8^{+0.02}_{-0.01}$ \\
  HIP 22958 & \nodata &     1 &  $6126 \pm 112$ &      30 &    -0.5 &          0 &  $1.4^{+0.22}_{-0.21}$ &  $1.2^{+0.04}_{-0.04}$ \\
  HIP 23362 & \nodata &     1 &  $6283 \pm 158$ &       5 &    -0.5 &          0 &  $1.2^{+0.06}_{-0.05}$ &  $1.2^{+0.07}_{-0.05}$ \\
  HIP 23916 & \nodata &     1 &  $5450 \pm 158$ &       5 &    -0.5 &          0 &  $1.1^{+0.20}_{-0.20}$ &  $0.9^{+0.04}_{-0.03}$ \\
  HIP 24902 & \nodata &     1 &  $5679 \pm 154$ &      30 &     0.0 &          0 &  $1.0^{+0.05}_{-0.04}$ &  $1.0^{+0.04}_{-0.03}$ \\
  HIP 25143 & \nodata &     1 &  $5883 \pm 109$ &      30 &     0.0 &          0 &  $1.1^{+0.04}_{-0.03}$ &  $1.1^{+0.05}_{-0.07}$ \\
  HIP 26126 & \nodata &     1 &   $5841 \pm 91$ &       5 &    -0.5 &          0 &  $1.0^{+0.03}_{-0.03}$ &  $1.0^{+0.05}_{-0.04}$ \\
  HIP 32607 & \nodata &     1 &   $5068 \pm 91$ &       5 &    -0.5 &          0 &  $0.8^{+0.02}_{-0.02}$ &  $0.9^{+0.01}_{-0.01}$ \\
  HIP 37450 & \nodata &     1 &   $nan \pm nan$ & \nodata & \nodata &          0 &    $nan^{+nan}_{-nan}$ &    $nan^{+nan}_{-nan}$ \\
  HIP 38593 & \nodata &     1 &  $5398 \pm 112$ &       5 &    -0.5 &          0 &  $1.3^{+0.08}_{-0.13}$ &  $0.9^{+0.03}_{-0.03}$ \\
  HIP 38846 & \nodata &     1 &  $6595 \pm 158$ &      10 &     0.0 &          0 &  $1.7^{+0.12}_{-0.21}$ &  $1.3^{+0.09}_{-0.05}$ \\
  HIP 39847 & \nodata &     1 &  $5750 \pm 107$ &      10 &    -0.5 &          0 &  $1.0^{+0.04}_{-0.03}$ &  $1.0^{+0.05}_{-0.03}$ \\
  HIP 40881 & \nodata &     1 &  $4562 \pm 154$ &      10 &    -0.5 &          0 &  $0.8^{+0.18}_{-0.05}$ &  $0.8^{+0.02}_{-0.03}$ \\
  HIP 42129 & \nodata &     1 &  $5241 \pm 158$ &      10 &    -0.5 &          0 &  $1.2^{+0.12}_{-0.18}$ &  $0.9^{+0.04}_{-0.02}$ \\
  HIP 42129 & \nodata &     1 &  $5241 \pm 158$ &      10 &    -0.5 &          0 &  $1.2^{+0.12}_{-0.18}$ &  $0.9^{+0.04}_{-0.02}$ \\
  HIP 46283 & \nodata &     1 &   $9268 \pm 85$ &      10 &     0.5 &          0 &    $nan^{+nan}_{-nan}$ &  $2.2^{+0.02}_{-0.02}$ \\
  HIP 55266 & \nodata &     1 &  $8483 \pm 139$ &      30 &    -0.5 &          0 &  $1.8^{+0.06}_{-0.04}$ &  $2.0^{+0.06}_{-0.05}$ \\
  HIP 63945 & \nodata &     1 &  $7038 \pm 162$ &      10 &    -0.5 &          0 &  $1.6^{+0.26}_{-0.16}$ &  $1.5^{+0.08}_{-0.06}$ \\
  HIP 72154 & \nodata &     1 &  $4918 \pm 162$ &      30 &    -0.5 &          0 &  $0.9^{+0.22}_{-0.09}$ &  $0.8^{+0.03}_{-0.03}$ \\
  HIP 76267 & \nodata &     1 &  $5449 \pm 158$ &       5 &    -0.5 &          0 &  $0.9^{+0.04}_{-0.04}$ &  $0.9^{+0.04}_{-0.03}$ \\
  HIP 77336 & \nodata &     1 &  $6407 \pm 112$ &      20 &     0.0 &          0 &  $1.2^{+0.04}_{-0.04}$ &  $1.3^{+0.04}_{-0.05}$ \\
  HIP 77516 & \nodata &     1 &  $6825 \pm 141$ &       5 &     0.5 &          0 &  $1.4^{+0.21}_{-0.06}$ &  $1.4^{+0.03}_{-0.04}$ \\
  HIP 78820 & \nodata &     1 &  $5658 \pm 158$ &       5 &    -0.5 &          0 &  $1.3^{+0.11}_{-0.13}$ &  $1.0^{+0.04}_{-0.04}$ \\
  HIP 79199 & \nodata &     1 &  $4616 \pm 158$ &       5 &    -0.5 &          0 &  $0.9^{+0.14}_{-0.14}$ &  $0.8^{+0.02}_{-0.03}$ \\
  HIP 79404 & \nodata &     1 &  $4773 \pm 112$ &      10 &    -0.5 &          0 &  $1.1^{+0.07}_{-0.08}$ &  $0.8^{+0.02}_{-0.01}$ \\
  HIP 80460 & \nodata &     1 &  $6391 \pm 155$ &      10 &     0.0 &          0 &  $1.2^{+0.06}_{-0.05}$ &  $1.3^{+0.06}_{-0.06}$ \\
  HIP 82673 & \nodata &     1 &  $4668 \pm 112$ &       5 &     0.5 &          0 &  $0.8^{+0.03}_{-0.03}$ &  $0.8^{+0.01}_{-0.02}$ \\
  HIP 84606 & \nodata &     1 &  $5476 \pm 154$ &      10 &    -0.5 &          0 &  $0.9^{+0.05}_{-0.04}$ &  $0.9^{+0.04}_{-0.03}$ \\
  HIP 88116 & \nodata &     1 &  $5293 \pm 112$ &       5 &     0.0 &          0 &  $0.9^{+0.03}_{-0.03}$ &  $0.9^{+0.02}_{-0.03}$ \\
  HIP 88818 & \nodata &     1 &   $5296 \pm 91$ &      20 &    -0.5 &          0 &  $0.9^{+0.02}_{-0.02}$ &  $0.9^{+0.02}_{-0.03}$ \\
  HIP 88817 & \nodata &     1 &  $3647 \pm 154$ &      20 &     0.0 &          0 &  $0.5^{+0.07}_{-0.10}$ &  $0.5^{+0.03}_{-0.05}$ \\
  HIP 91118 & \nodata &     1 &  $6492 \pm 155$ &      10 &    -0.5 &          0 &  $1.3^{+0.26}_{-0.07}$ &  $1.3^{+0.06}_{-0.06}$ \\
  HIP 93805 & \nodata &     1 &  $4054 \pm 109$ &       5 &    -0.5 &          0 &  $0.6^{+0.03}_{-0.03}$ &  $0.6^{+0.04}_{-0.02}$ \\
  HIP 96840 & \nodata &     1 &  $9942 \pm 152$ &      10 &     0.0 &          0 &    $nan^{+nan}_{-nan}$ &  $2.3^{+0.03}_{-0.01}$ \\
 HIP 100221 & \nodata &     1 &  $5273 \pm 154$ &      20 &    -0.5 &          0 &  $0.9^{+0.29}_{-0.07}$ &  $0.9^{+0.04}_{-0.03}$ \\
 HIP 100907 & \nodata &     1 &  $5222 \pm 109$ &      10 &     0.0 &          0 &  $0.9^{+0.03}_{-0.03}$ &  $0.9^{+0.04}_{-0.02}$ \\
 HIP 103298 & \nodata &     1 &   $4615 \pm 90$ &       5 &    -0.5 &          0 &  $0.7^{+0.02}_{-0.02}$ &  $0.8^{+0.01}_{-0.02}$ \\
 HIP 109139 & \nodata &     1 &  $5710 \pm 112$ &      20 &    -0.5 &          0 &  $1.0^{+0.04}_{-0.03}$ &  $1.0^{+0.03}_{-0.03}$ \\
 HIP 109521 & \nodata &     1 &   $4412 \pm 87$ &      10 &     0.0 &          0 &  $0.7^{+0.02}_{-0.02}$ &  $0.7^{+0.01}_{-0.01}$ \\
 HIP 115115 & \nodata &     1 &   $4943 \pm 91$ &       5 &    -0.5 &          0 &  $0.8^{+0.02}_{-0.02}$ &  $0.8^{+0.02}_{-0.02}$ \\
